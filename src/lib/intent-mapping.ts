...
export const INTENT_RULES: IntentToKajabiRule[] = [
  ...
  { intent: 'icon_card_row',      allowedSectionTypes: ['section'], preferredSectionType: 'section', fallbackSectionType: 'section', excludeFromContent: false, requiresStrongEvidence: false, minConfidence: 0.6, minItems: 2 },
